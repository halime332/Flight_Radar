  ...
  return (
    <div className="modal-outer">
        <div className="modal-inner">
           ...
           {isLoading ?( <Loader/>) :
           error ? (<Error msg={error}/>) : isVIP ? <h3 className="loader-wrapper">Uçuş Bilgileri gizlendi</h3> : info && ( 
           <> 
           <div className="info-wrapper">
              <div className="info">
               ...
               <p>
                ...
                <p>
                    <span>Kalkış</span>
                    <a href={info.airport.origin?.website} target="_black">{info.airport.origin.name}</a>
                </p>
                <p>
                    <span>Hedef</span>
                    <a href={info.airport.destination?.website} target="_black">{info.airport.destination?.name}</a>
                </p>
